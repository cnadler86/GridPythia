...
def load_provider_from_config(cfg: LoadProfileConfig) -> LoadProvider:
    ...
    JSON files map to :class:`~src.prediction.load.profilejson.LoadProfileJSON`;
    CSV files map to :class:`~src.prediction.load.profilecsv.LoadProfileCSV`.
    """
    # Lazy imports to avoid circular dependency (subclasses import from this module).
    from src.prediction.load.profilecsv import LoadProfileCSV  # noqa: PLC0415
    from src.prediction.load.profilejson import LoadProfileJSON  # noqa: PLC0415
